				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('OR... You can just enter a chord name: G fom G major; a for a minor.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$Main$chordTransform = function (note) {
	var _p0 = note;
	switch (_p0) {
		case 'A':
			return {
...
var _user$project$Main$stringNo = function (a) {
	return A2(
		_elm_lang$core$Result$withDefault,
		0,
		_elm_lang$core$String$toInt(
			A2(_elm_lang$core$String$left, 1, a)));
};
var _user$project$Main$fretNo = function (a) {
	return A2(
		_elm_lang$core$Result$withDefault,
		50,
		_elm_lang$core$String$toInt(
...
var _user$project$Main$tabLines = function () {
	var lineStyle = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border', _1: '1px solid #aaa'},
			_1: {
	...
	var tabItem = function (a) {
		if (_elm_lang$core$Native_Utils.eq(
			...
			var note = A2(
				...
				{fret: 0, string: 1},
				_elm_lang$core$List$head(a));
			return _elm_lang$core$Native_Utils.eq(note.fret, 50) ? A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
				...
				},
				{
					...
					_1: {ctor: '[]'}
				}) : (_elm_lang$core$Native_Utils.eq(note.string, 9) ? A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'borderLeft', _1: '2px solid #aaa'},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'borderRight', _1: '2px solid #aaa'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'zIndex', _1: '1'},
											_1: {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'marginTop',
									_1: _user$project$Main$noteXpos(note.string)
								},
								_1: {
									ctor: '::',
			...
			var mapper = function (b) {
				return _elm_lang$core$Native_Utils.eq(b.fret, 50) ? A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(b.fret)),
						_1: {ctor: '[]'}
					});
			};
			var finalDiv = A2(_elm_lang$core$List$map, mapper, a);
			return A2(
				_elm_lang$html$Html$div,
				{
					ctor: '::',
...
var _user$project$Main$splitNotes = function (note) {
	if (_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$length(note),
		12)) {
		var mapper = function (a) {
			return A2(
				_user$project$Main$Tab,
				_user$project$Main$fretNo(a),
				_user$project$Main$stringNo(a));
		};
		var e = A3(_elm_lang$core$String$slice, 10, 12, note);
		var b = A3(_elm_lang$core$String$slice, 8, 10, note);
		var g = A3(_elm_lang$core$String$slice, 6, 8, note);
		var d = A3(_elm_lang$core$String$slice, 4, 6, note);
		var a = A3(_elm_lang$core$String$slice, 2, 4, note);
		var e6 = A3(_elm_lang$core$String$slice, 0, 2, note);
		return A2(
			_elm_lang$core$List$map,
			mapper,
			{
		...
		if (_elm_lang$core$Native_Utils.eq(
			...
			A3(_elm_lang$core$String$slice, 1, 2, note),
			'#')) {
			var mapper = function (a) {
				return A2(
					_user$project$Main$Tab,
			...
			return A2(
				_elm_lang$core$List$map,
				mapper,
				_user$project$Main$chordTransform(note));
		} else {
			return {
				ctor: '::',
				_0: A2(
					_user$project$Main$Tab,
					_user$project$Main$fretNo(note),
					_user$project$Main$stringNo(note)),
				_1: {ctor: '[]'}
			};
		}
	}
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'ReadTab':
				...
				var readNotes = A2(_elm_lang$core$String$split, ' ', _p2._0);
